...
const SLIDES: Slide[] = [
  {
    ...
    subtitle:
      'Jogos, consolas e acessórios usados — testados, classificados por estado e prontos para jogar. Vendemos, compramos e damos uma segunda vida a cada cartucho.',
  ...
  },
  {
    ...
    image: '/images/banner/reparacao.png',
    textColor: '#D4A373',
  },
];
